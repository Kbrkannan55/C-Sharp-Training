...
namespace FinalAPIProject.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Cusid,Cusname,Cusph,Cusaddress,Cuspassword")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Cusid,Cusname,Cusph,Cusaddress,Cuspassword")] Customer customer)
        {
