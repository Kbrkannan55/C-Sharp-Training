...
namespace JWTCodeFirst.Controllers
{
...
namespace ProjectAPI.Controllers
{
    ...
    public class Auth : ControllerBase
    {
        ...
        //we create
        public Auth(UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager, IConfiguration config)
        {
